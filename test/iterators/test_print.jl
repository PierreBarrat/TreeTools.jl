...
print("empty node: \n")
n = TreeNode()
empty_t = TreeTools.node2tree(n);
TreeTools.print_tree_ascii(IO, empty_t)

print("single node: \n")
t1 = parse_newick_string("A:1")
TreeTools.print_tree_ascii(IO, t1)
...
TreeTools.print_tree_ascii(IO, t2)
